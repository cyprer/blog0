...
<div style="text-align: center;">
  <img id="switchImage" src="image1.jpg" style="max-width: 600px; cursor: pointer;">
  <div style="margin-top: 10px;">
    <button onclick="prevImage()">← 上一个</button>
    <button onclick="nextImage()">下一个 →</button>
  </div>
</div>

<script>
const images = [
    ![1](https://raw.githubusercontent.com/cyprer/photo/main/obsidian/20250314003500121.png),
    ![2]https://raw.githubusercontent.com/cyprer/photo/main/obsidian/20250314003624286.png)
];
let currentIndex = 0;

function updateImage() {
  document.getElementById("switchImage").src = images[currentIndex];
}
